...
Windows에서 행사별 체크리스트, 담당자, 업체, 정산과 달력을 관리하는 로컬 데스크톱 프로그램입니다. 새 업무는 날짜 없이 생성되며 작업 시작일과 마감일은 체크리스트에서 직접 입력합니다.
...
- `v0.3.11`처럼 앱 버전과 같은 태그를 push하면 GitHub Actions가 테스트, Windows 빌드와 Release 파일 생성을 자동 수행합니다.
