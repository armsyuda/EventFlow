...
def test_new_release_is_detected(monkeypatch):
    payload = {
        ...
        "html_url": "https://github.com/armsyuda/EventFlow/releases/tag/v0.3.10",
        "body": "새 기능",
        "assets": [{
            "name": "EventFlow-Windows.zip",
            "browser_download_url": "https://github.com/armsyuda/EventFlow/releases/download/v0.3.10/EventFlow-Windows.zip",
            "digest": "sha256:abc",
        }],
    }
    ...
    assert info and info.version == "0.3.10"
